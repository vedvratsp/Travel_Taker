...
//        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    final String url="https://www.skyscanner.ca/flights";
...
//        params.putString("class", "CurrencyConverter");
//        params.putString("userid", "12564578");
//        firebaseAnalytics.logEvent("CurrencyConverter", params);
    ...
    final public void onActivityResult(int requestCode, int resultCode, Intent intent)
    {
        ...
        else if (requestCode == FILECHOOSER_RESULTCODE)
        {
            if (null == mUploadMessage)
                return;
            // Use CurrencyConverter.RESULT_OK if you're implementing WebViewFragment inside Fragment
...
//                            CurrencyConverter.super.onBackPressed();
//                        }
//                    }).create().show();
//        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.webmain, optionsMenu);
